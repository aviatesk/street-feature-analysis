...
1. First you have to make Git, Python and the libraries below available on your machine. My versions are shown after colons.
    - [Python](https://www.python.org/): `sys.version == '3.6.8 |Anaconda, Inc.| (default, Feb 21 2019, 18:30:04) [MSC v.1916 64 bit (AMD64)]'`
    ...
    - [Pillow](https://pillow.readthedocs.io/en/stable/): `PIL.__version__ == 5.4.1`    
...
- [src](src): Scripts for collecting/processing data and supporting running the Jupyter notebooks in [notebooks] directory
    ...
    - [guided_grad_cam.py](src/guided_grad_cam.py): Computes (Guided) Grad-CAM for run.py
    ...
    - [preprocess.py](src/preprocess.py): Preprocesses the crawled data by crawl.py
